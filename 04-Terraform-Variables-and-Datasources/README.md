...
- [Terraform Input Variable Usage - 10 different types](https://github.com/terraform-learning/hashicorp-certified-terraform-associate/tree/main/05-Terraform-Variables/05-01-Terraform-Input-Variables)
```t
# AWS Region
variable "aws_region" {
